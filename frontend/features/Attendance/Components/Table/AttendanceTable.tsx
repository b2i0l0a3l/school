        ...
        () => [
            ...
            columnHelper.accessor("status", {
                ...
                cell: (info) => {
                    ...
                    let colorClasses = '';
                    if (status === 'حاضر') colorClasses = 'bg-emerald-500/15 text-emerald-400 border-emerald-500/20';
                    else if (status === 'غائب') colorClasses = 'bg-rose-500/15 text-rose-400 border-rose-500/20';
                    else colorClasses = 'bg-amber-500/15 text-amber-400 border-amber-500/20';
